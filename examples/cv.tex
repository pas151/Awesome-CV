...
\name{Paxton}{Scott}
\position{Backend Engineer{\enskip\cdotp\enskip}Software Engineer}
% \address{235, World Cup buk-ro, Mapo-gu, Seoul, 03936, Republic of Korea}

\mobile{(+1) 806-759-9399}
\email{paxtonnscott@gmail.com}
% \dateofbirth{January 1st, 1970}
% \homepage{www.posquit0.com}
\github{pas151}
\linkedin{paxtonscott}
% \gitlab{gitlab-id}
